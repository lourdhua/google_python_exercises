...
def donuts(count):
  # +++your code here+++
  if count >= 10:
    numd = 'Number of donuts: many'
  else:
    numd = 'Number of donuts: '+str(count)
  print ('donut function:',numd)
  return numd
...
def mix_up(a, b):
  # +++your code here+++
  swapped = b[0:2]+a[2:]+' '+a[0:2]+b[2:]
  print('swapped string: ',a, b)
  return swapped
